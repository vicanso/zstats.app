...
pub fn render(state: &ZStatsAppState) -> Vec<AnyElement> {
    let Some(tick) = state.latest() else {
        return vec![widgets::empty_card(i18n::tr("sensors.title"), i18n::tr("common.waiting_sample"))];
    };
                    ...
                    .child(
                        div()
                            ...
                            .child(match (t.max_celsius, t.critical_celsius) {
                                ...
                                (None, Some(c)) => {
                                    t!("sensors.crit_only", crit = format!("{c:.0}")).to_string()
                                }
            ...
            .child(widgets::kv_columns(vec![
                ...
                (
                    ...
                    b.time_to_empty_secs
                        .map_or("—".to_string(), format::uptime),
                ),
                (
